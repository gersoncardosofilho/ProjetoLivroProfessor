...
public class CircleToolHandler implements ToolHandler {
    ...
    private void createAnnot() {
        if (mPdfViewCtrl.isPageVisible(mLastPageIndex)) {
            ...
            try {
                ...
                final Circle newAnnot = (Circle) page.addAnnot(Annot.e_annotCircle, bboxRect);
                ...
                undoItem.mBorderStyle = Annot.e_borderStyleSolid;
    ...
    public void init() {
        ...
        if (0 == mColor) {
            mColor = PropertyBar.PB_COLORS_CIRCLE[0];
        }
        if (0 == mOpacity) {
            mOpacity = 100;
        }
        ...
        mToolBtn.setOnLongClickListener(new OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                ...
                if (((UIExtensionsManager)mPdfViewCtrl.getUIExtensionsManager()).getCurrentToolHandler() != CircleToolHandler.this) {
                    ((UIExtensionsManager)mPdfViewCtrl.getUIExtensionsManager()).setCurrentToolHandler(CircleToolHandler.this);
                }
                return true;
            }
        });
