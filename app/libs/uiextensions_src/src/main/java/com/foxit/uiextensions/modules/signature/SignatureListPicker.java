...
public class SignatureListPicker {
    ...
    private ISignListPickerDismissCallback mSignListPickerDismissCallback;//todo
    ...
    public SignatureListPicker(Context context, ViewGroup parent, PDFViewCtrl pdfViewCtrl, SignatureFragment.SignatureInkCallback inkCallback) {
        mContext = context;
        mParent = parent;
    ...
    private void initTopBar() {
        ...
        mSignPickerTitleItem.setText(AppResource.getString(mContext, R.string.rv_sign_model));
        ...
        mSignPickerCreateItem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (fragment == null) {
                    ...
                    fragment.init(mContext, mParent, mPdfViewCtrl);
                }
    ...
    private void initGroupItems() {
        ...
        handwritingInkGroupItem.name = AppResource.getString(mContext, R.string.sg_signer_handwriting_group_title);
        ...
        if(((UIExtensionsManager)mPdfViewCtrl.getUIExtensionsManager()).getModuleByName(Module.MODULE_NAME_DIGITALSIGNATURE) != null) {
            ...
            dsgInkGroupItem.name = AppResource.getString(mContext, R.string.sg_signer_dsg_group_title);
