...
public class CertificateDetailDialog extends UIMatchDialog {
	...
	private View createView() {
        ...
        if (mPermDialogType == PERMDLG_TYPE_DECRYPT) {
            setTitle(mContext.getString( R.string.rv_security_information_certlist_title));
        } else {
            setTitle(mContext.getString(R.string.rv_certlist_note ));
        }
	...
	class InfoAdapter extends BaseAdapter{
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			switch (position) {
			case 0:
				holder.name.setText(AppResource.getString(mContext, R.string.rv_security_information_certlist_serialnumber));
				holder.value.setText(mCertInfo.certificateInfo.serialNumber);
				break;
			case 1:
				holder.name.setText(AppResource.getString(mContext, R.string.rv_security_information_certlist_publisher));
				holder.value.setText(mCertInfo.certificateInfo.publisher);
				break;
			case 2:
				holder.name.setText(AppResource.getString(mContext, R.string.rv_security_information_certlist_startdate));
				holder.value.setText(mCertInfo.certificateInfo.startDate);
				break;
			case 3:
				holder.name.setText(AppResource.getString(mContext, R.string.rv_security_information_certlist_expiringdate));
				holder.value.setText(mCertInfo.certificateInfo.expiringDate);
				break;
			case 4:
				holder.name.setText(AppResource.getString(mContext, R.string.rv_security_information_certlist_email));
