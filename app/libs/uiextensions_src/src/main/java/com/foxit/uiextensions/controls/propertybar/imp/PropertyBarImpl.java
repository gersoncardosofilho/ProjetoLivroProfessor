...
public class PropertyBarImpl extends PopupWindow implements PropertyBar {
    ...
    private View getColorView() {
        ...
        ColorPicker colorPicker = new ColorPicker(mContext, ((UIExtensionsManager) mPdfViewCtrl.getUIExtensionsManager()).getRootView());
    ...
    private void initColorOne(LinearLayout pb_ll_colors) {
        ...
        int tempWidth = viewGroup.getWidth();
        int tempHeight = viewGroup.getHeight();
        ...
        if (this != null && !this.isShowing()) {
            ...
            if (display.isPad()) {
                ...
                if (arrowPosition == ARROW_BOTTOM) {
                    ...
                    showAtLocation(viewGroup, Gravity.LEFT | Gravity.TOP, toLeft, (int) (rectF.top - mLl_root.getMeasuredHeight()));
                } else if (arrowPosition == ARROW_TOP) {
                    mIvArrowTop.measure(0, 0);
                    ...
                    showAtLocation(viewGroup, Gravity.LEFT | Gravity.TOP, toLeft, (int) rectF.bottom);
                } else if (arrowPosition == ARROW_LEFT) {
                    mIvArrowLeft.measure(0, 0);
                    ...
                    showAtLocation(viewGroup, Gravity.LEFT | Gravity.TOP, (int) (rectF.right), toTop);
                } else if (arrowPosition == ARROW_RIGHT) {
                    mIvArrowRight.measure(0, 0);
                    ...
                    showAtLocation(viewGroup, Gravity.LEFT | Gravity.TOP,
                ...
                setWidth(width);
                showAtLocation(viewGroup, Gravity.LEFT | Gravity.BOTTOM, 0, AppDisplay.getInstance(mContext).getNavBarHeight());
