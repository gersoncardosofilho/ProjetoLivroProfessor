...
public class BrightnessModule implements Module {
    ...
    IMultiLineBar.IML_ValueChangeListener mLinkToSystemChangeListener = new IMultiLineBar.IML_ValueChangeListener() {
        @Override
    ...
    IMultiLineBar.IML_ValueChangeListener mBrightnessSeekValueChangeListener = new IMultiLineBar.IML_ValueChangeListener() {
        @Override
        public void onValueChanged(int type, Object value) {
    ...
    IMultiLineBar.IML_ValueChangeListener mDayNightModeChangeListener = new IMultiLineBar.IML_ValueChangeListener() {
        @Override
        public void onValueChanged(int type, Object value) {
