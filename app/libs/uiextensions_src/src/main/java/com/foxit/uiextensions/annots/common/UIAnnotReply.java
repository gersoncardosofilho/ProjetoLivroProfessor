...
public class UIAnnotReply {
    ...
    public static void replyToAnnot(final PDFViewCtrl pdfViewCtrl, final ViewGroup parent, final Annot annot) {
        ...
        if (!(activity instanceof FragmentActivity)) {
            Toast.makeText(activity.getApplicationContext(), "The attached activity is not a FragmentActivity", Toast.LENGTH_LONG);
            return;
        }
                ...
                addReplyAnnot(pdfViewCtrl, annot, page,
                        AppDmUtil.randomUUID(null), content, new Event.Callback() {
                            ...
                            public void result(Event event, boolean success) {
                                showComments(pdfViewCtrl, parent, annot);
                            }
                        });
            }
    ...
    public static void showComments(final PDFViewCtrl pdfViewCtrl, ViewGroup parent, Annot annot) {
        ...
        fragment.init(pdfViewCtrl, parent, annot);
    ...
    public static void addReplyAnnot(final PDFViewCtrl pdfViewCtrl, final Annot annot, final PDFPage page, final String nm, final String content, final Event.Callback callback) {
        try {
            ...
            DocumentManager.getInstance(pdfViewCtrl).addAnnot(page, new ReplyContent(pageIndex, nm, content, annot.getUniqueID()), true, callback);
        } catch (PDFException e) {
            e.printStackTrace();
        }
    }
    ...
    public static class CommentContent implements AnnotContent {
        ...
        public int getType() {
            ...
            return Annot.e_annotUnknownType;
        }
        ...
        public int getColor() {
            try {
                return (int) annot.getBorderColor();
            } catch (PDFException e) {
                e.printStackTrace();
            }
            return 0;
    ...
    public static class ReplyDialog extends DialogFragment {
        ...
        public View createView() {
            ...
            ((TextView) view.findViewById(R.id.rd_note_dialog_edit_title)).setText(getActivity().getString(mTitleID));
    ...
    public static class CommentsFragment extends DialogFragment {
        ...
        private void init() {
            ...
            try {
                ...
                for (int i = 0; i < count; i++) {
                    ...
                    if (annot == null || AppAnnotUtil.isSupportGroupElement(annot) || !AppAnnotUtil.isSupportEditAnnot(annot))
                        continue;
        ...
        private void beginToDelete() {
            if (checkDeleteStatus() == DELETE_SRCAN) {
                if (mSRDeleteDialog == null || mSRDeleteDialog.getDialog().getOwnerActivity() == null) {
                    ...
                    mSRDeleteDialog.getPromptTextView().setText(getActivity().getString(R.string.rv_panel_annot_delete_tips));
                    mSRDeleteDialog.setTitle(getActivity().getString(R.string.cloud_delete_tv));
        ...
        class CommentsAdapter extends BaseAdapter {
            ...
            public void removeNode(final AnnotNode node) {
                ...
                try {
                    DocumentManager.getInstance(mPDFViewCtrl).removeAnnot(node.replyAnnot, true, null);
                } catch (Exception e) {
                    e.printStackTrace();
                }
                        ...
                        public void onClick(View v) {
                            ...
                            replyToAnnot(mPDFViewCtrl, mParent, editable, TITLE_EDIT_ID, new ReplyCallback() {
                                ...
                                public void result(final String content) {
                                    ...
                                    DocumentManager.getInstance(mPdfViewCtrl).modifyAnnot(node.replyAnnot, new CommentContent(node.replyAnnot, content),
                    ...
                    public void onClick(View v) {
                        ...
                        replyToAnnot(mPDFViewCtrl, mParent, editable, TITLE_EDIT_ID, new ReplyCallback() {
                            ...
                            public void result(final String content) {
                                final Annot annot = node.replyAnnot;
                                if (annot == null) return;
                                DocumentManager.getInstance(mPdfViewCtrl).modifyAnnot(node.replyAnnot, new CommentContent(annot, content), true, new Event.Callback() {
                                    @Override
                                    public void result(Event event, boolean success) {
                                        if (success) {
                                            try {
