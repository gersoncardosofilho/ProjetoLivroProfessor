...
public class ReflowModule implements Module {
    ...
    private void resetAnnotPanelView(boolean showAnnotPanel) {
        if (((UIExtensionsManager) mUiExtensionsManager).isHiddenPanel(PanelSpec.PanelType.Annotations)) return;
    ...
    private IMultiLineBar.IML_ValueChangeListener mReflowChangeListener = new IMultiLineBar.IML_ValueChangeListener() {
        @Override
