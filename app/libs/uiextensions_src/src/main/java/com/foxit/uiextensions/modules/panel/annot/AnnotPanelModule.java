...
public class AnnotPanelModule implements Module, PanelSpec {
    ...
    public void show() {
        ...
        mPanelHost.setCurrentSpec(PanelType.Annotations);
    ...
    public boolean unloadModule() {
        ...
        DocumentManager.getInstance(mPdfViewCtrl).unregisterAnnotEventListener(mAnnotPanel.getAnnotEventListener());
        if (mUiExtensionsManager != null && mUiExtensionsManager instanceof UIExtensionsManager) {
